...
#ifndef SQUIM_IMAGE_CODECS_PNG_DECODER_H_
#define SQUIM_IMAGE_CODECS_PNG_DECODER_H_
...
class PngDecoder : public ImageDecoder {
 ...
 public:
  ...
  PngDecoder(Params params, std::unique_ptr<io::BufReader> source);
  ~PngDecoder() override;
...
#endif  // SQUIM_IMAGE_CODECS_PNG_DECODER_H_
