// Copy of chromium base/strings/string_piece_unittest.cc
...
class CommonStringPieceTest : public ::testing::Test {
 public:
  static const T as_string(const char* input) { return T(input); }
  static const T& as_string(const T& input) { return input; }
};
