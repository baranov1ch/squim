...
const char* kValidPngSuiteFiles[]{
    ...
    "tr-basn4a08", "tr-t1-8pB",  "tr-t2-8pb", "tr-t3-32pB", "tr-t4-32pb",
    "tr-t5-64pB",  "tr-t6-64pb", "z00n2c08",  "z03n2c08",   "z06n2c08",
    "z09n2c08",
};
...
class PngDecoderTest : public testing::Test {
 protected:
  void ValidatePngRandomReads(const std::string& filename,
    ...
    ValidateDecodeWithReadSpec(filename, data, CreateDecoder, LoadReferencePng,
                               read_spec, read_type);
  }
